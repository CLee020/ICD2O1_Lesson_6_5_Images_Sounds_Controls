...
while running:
    ...
    if keys[pygame.K_UP] == True and player2_y > 0:
      player2_y -= 5
    if keys[pygame.K_DOWN] == True and (player2_y < HEIGHT - player2_img.get_height() - platform_img.get_height()):
      player2_y += 5
    if keys[pygame.K_LEFT] == True and player2_x > 0:
      player2_x -= 5
    if keys[pygame.K_RIGHT] == True and (player2_x < WIDTH - player2_img.get_width()):
      player2_x += 5
    # ----- GAME STATE UPDATES -----
